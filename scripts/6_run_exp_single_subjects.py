...
FEATURES = [
    # Base
    "3_phone_features",
    "5_low_level_features",
    # Layer 0
    # "phone_sum-gpt2-0.equiv-10",
    "phone_sum-gpt2-0.equiv-1",
    "phone_sum-gpt2-0",
    # Layer 9
    "phone_sum-gpt2-9.equiv-1",
    # "phone_sum-gpt2-9.equiv-10",
    "phone_embedding_sum-gpt2-9.equiv-1",
    # "phone_embedding_sum-gpt2-9.equiv-10",
    "phone_sum-gpt2-9",
    # Controls
    "phone_equal_len_sentence.sum-gpt2-9",
    "phone_shuffle_in_sentence.sum-gpt2-9",
    "phone_shuffle_in_task.sum-gpt2-9",
]
